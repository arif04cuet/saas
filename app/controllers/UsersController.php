...
//    	$this->view->setTemplateBefore('private');
    ...
    public function searchAction()
    {
        ...
        if ($this->request->isPost()) {
            ...
            $query->addWhere('domain_id = ' . $this->getDomainId());
            if (!$this->isAdministrator()) {
                $query->addWhere('profilesId > ' . $this->getUserProfileId());
            }
    ...
    public function createAction()
    {
        if ($this->request->isPost()) {
            ...
            $user->assign(array(
                ...
                'designation' => $this->request->getPost('designation', 'striptags'),
                'id_number' => $this->request->getPost('id_number', 'striptags'),
            ...
            if (!$user->save()) {
                ...
                $message = 'Created User :' . $this->request->getPost('name', 'striptags');
                $this->log($message);
    ...
    public function editAction($id)
    {
        ...
        if ($this->request->isPost()) {
            ...
            if (!$user->save()) {
                ...
                $message = 'Updated User :' . $this->request->getPost('name', 'striptags');
                $this->log($message);
        ...
        if ($this->request->isPost()) {
            ...
            if (!$form->isValid($this->request->getPost())) {
                ...
                if (!$passwordChange->save()) {
                    ...
                    $message = 'Chaanged password for User :' . $user->name;
                    $this->log($message);
