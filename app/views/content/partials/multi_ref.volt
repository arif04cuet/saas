    ...
    <tr>
        <td>
            <div class="input-append">
                {{ text_field(fldname~"["~i~"][link]","value":fldv['link'],'readonly':'readonly') }}
                <a id="btn-contentref" href="javascript:;" role="button" class="btn" onclick="return showSelectContent(this,'{{ fldrefname }}'); return false;"><i class="icon-search"></i></a>
            </div>
        </td>
...
<script>
    ...
    function addRow{{fldname}}(){
        var t =     '<tr>' +
                    ...
                    '<input readonly="readonly" type="text" value="" name="{{fldname}}['+i_{{fldname}}+'][link]">' +
