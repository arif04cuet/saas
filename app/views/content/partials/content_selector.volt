    ...
    <div class="modal-body">
        <div class="clearfix3">
            <div class="input-append">
                ...
                <a href="javascript:;" class="btn"  onclick="return ModalContentSelector.searchContentByType(1);"><i class="icon-search"></i></a>
            </div>
            <!--
            <div class="input-append">
...
//            var contentTypeName = $("ul.typeahead.dropdown-menu").find('li.active').data('value');;
            ...
            $('#'+ModalContentSelector.populateText).val("/site/"+contentTypeName+"/"+id);
