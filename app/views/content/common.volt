...
<table id="data" class="table table-condensed table-hover table-striped">
    <thead>
    <tr>
...
<script type="application/javascript">
    $(document).ready(function () {
        ...
        var $commonFields = 'id,publish,version,lastmodified,title_bn';
        var $columns = $commonFields;
