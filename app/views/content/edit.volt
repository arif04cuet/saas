...
<div class="row">
    ...
    {% for fld  in formFields %}
        ...
        <div class="clearfix">
            ...
            <!-- Nav tabs -->
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="{{fld['name']}}_bn">
                        ...
                        {{ text_area(ttt,"class":"input-xxlarge","value":contentValues[ttt]) }}
                    </div>
                    <div class="tab-pane" id="{{fld['name']}}_en">
            ...
            {% elseif fld['type'] == "multicontentref" %}
            		{{ partial("content/partials/multi_ref", ['fldname': fld['name'],'fldrefname': fld['contentname'],'fldrefname': contentValues[fld['name']][0]]) }}
            ...
            {{ partial("content/partials/multi_domain_selector", ['fldname': fld['name'],'fldval':contentValues[fld['name']]]) }}
    ...
    <div class="clearfix">
        ...
        {% if contentValues['is_right_side_bar']=='1' %}
            {{ check_field('is_right_side_bar',"value":"1",'checked':'checked') }}
        {% else %}
