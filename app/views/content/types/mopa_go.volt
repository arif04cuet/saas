...
<table id="data" class="officerList table table-condensed table-hover table-striped">
    ...
    <tr>
        ...
        <th class="search">Iss. No</th>
        <th class="search">Go Type</th>
        <th class="">W/B/S</th>
...
<script type="application/javascript">
    $(document).ready(function () {
        ...
        $('#data thead th.search').each(function () {
            var title = $(this).text();
            $(this).html('<input type="text" class="searchTitle" placeholder="  ' + title + '" />');
        });

        var $contentType = "{{ contentType }}";
        var $domainId = "{{ domainId }}";
        var $domainName = "mopa.portal.gov.bd";
        var $columns = 'id,publish,version,lastmodified,title_bn,go_type,wing,branch,section';
