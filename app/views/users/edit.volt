...
<div class="center scaffold">
    ...
    <ul class="nav nav-tabs">
        ...
        <li><a href="#B" data-toggle="tab">Offices</a></li>
        <li><a href="#C" data-toggle="tab">Successful Logins</a></li>
        <li><a href="#D" data-toggle="tab">Password Changes</a></li>
        <li><a href="#E" data-toggle="tab">Reset Passwords</a></li>
    </ul>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" id="B">
            ...
            <table class="table table-bordered table-striped" align="center">
                ...
                <tbody>
                {% for office in user.npfoffices %}
                <tr>
                    <td>{{ link_to("offices/edit/"~office.office.id, office.office.name_bn) }}</td>
                </tr>
                {% else %}
                <tr><td colspan="3" align="center">No Office Assigned.</td></tr>
                {% endfor %}
                </tbody>
            </table>
            </p>
