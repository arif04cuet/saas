    ...
    {% if loop.last %}
        ...
        <tr>
            <td colspan="10" align="right">
                <div class="btn-group">
                    {{ link_to("feedback/search", '<i class="icon-fast-backward"></i> First', "class": "btn") }}
                    {{ link_to("feedback/search?page=" ~ page.before, '<i class="icon-step-backward"></i> Previous', "class": "btn ") }}
                    {{ link_to("feedback/search?page=" ~ page.next, '<i class="icon-step-forward"></i> Next', "class": "btn") }}
                    {{ link_to("feedback/search?page=" ~ page.last, '<i class="icon-fast-forward"></i> Last', "class": "btn") }}
