...
{% for resource, actions in acl.getResources() %}
	...
	<table class="table table-bordered table-striped" align="center">
		...
		<tbody>
			...
			<tr>
				<td align="center"><input type="checkbox" name="permissions[{{ resource ~ '.' ~ action }}]" value="{{ resource ~ '.' ~ action }}"  {% if permissions[resource ~ '.' ~ action] is defined %} checked="checked" {% endif %}></td>
