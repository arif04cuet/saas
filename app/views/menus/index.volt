...
<ul class="pager">
    ...
    <li class="pull-right">
            <a id="saveall" href="javascript:;" onclick="saveAllMenu(this);return false;" class="btn btn-success">Save All</a>
            <span id="roller" style="display: none;margin:0;"><img width="15px" src="img/loading.gif"></span>
    </li>
</ul>

<div id="menu-list" class="span7">
    {{ menu }}
</div>
    ...
    <form id="frm_menu" method="post" autocomplete="on"  style="background-color: #eee; padding: 5px 10px;">
        ...
        <div class="clearfix3">
            ...
            <div class="input-append">
                ...
                <a id="btn-contentref" onclick="showSelectContent(this,''); return false;" href="#" role="button" class="btn" data-toggle="modal"><i class="icon-search"></i></a>
...
<script>
    ...
    function getFormDataInJson(mid){
        ...
        var mlnktp = $('#menu-link-type').val();
        var mact = $('#menu-active').prop('checked')?1:0;
        var jsonDt = {"id":mid,"title_en":mttlen,"link_path":mlnk,"link_type":mlnktp,"external":mex,"active":mact,"title_bn":mttlbn};
        return jsonDt;
    }
...
//        console.debug(jsonDt);
    ...
    function onEditMenu(t){
        ...
        $('#menu-link-type').val(jsonDt.link_type);
    }
