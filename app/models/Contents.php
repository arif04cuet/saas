...
//        echo $phql;
    ...
    public static function deactivateAllContent($edit, $contentTypeName, $id){
        ...
        $content = new Contents();
        $content->getReadConnection()->query($sql);
        return true;
    }
...
//            $fldVals['publish'] = '0';
        ...
        $content->getWriteConnection()->query($phql,$fldVals);

        //$tmp['result'] = new Resultset(null, $content, $content->getWriteConnection()->query($phql,$fldVals));
