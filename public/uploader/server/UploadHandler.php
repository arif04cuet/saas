...
class UploadHandler
{
    ...
    function __construct($upload_loc = '', $options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            'script_url' => $this->get_full_url().'/',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/../../files/'.$upload_loc,
            'upload_url' => '/files/'.$upload_loc,
    ...
    protected function set_additional_file_properties($file) {
        $file->deleteUrl = $this->options['script_url']//.'/'.$upload_loc
            .$this->get_query_separator($this->options['script_url'])
			.'uppth='.$this->options['upload_loc'].'&'
